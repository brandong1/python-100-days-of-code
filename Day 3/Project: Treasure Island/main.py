...
if choice1 == "left":
    ...
    if choice2 == "wait":
        choice3 = input(
            "You arrive at the island unharmed. There is a house with three doors; one red, on yellow an one blue. Which color do you choose?").lower()
        if choice3 == "red":
            print("It's a room full of FIRE! GAME OVER!!")
        elif choice3 == "yellow":
            print("You foun the treasure! You're rich!!")
        elif choice3 == "blue":
